...
class VisitSummaryCard(BaseModel):
    ...
    component_type: str = Field(default="visit_summary_card", frozen=True)
    visit_date: str
    provider_name: str
...
class SymptomAnalysisCard(BaseModel):
    ...
    component_type: str = Field(default="symptom_analysis_card", frozen=True)
...
class LabReportCard(BaseModel):
    ...
    component_type: str = Field(default="lab_report_card", frozen=True)
    report_date: str
